...
create table sub_privileges(
    ...
    FOREIGN KEY (`user_id`) REFERENCES sub_users(`id`)
...
create table sub_bangumis(
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY (`creator`) REFERENCES sub_users(`id`),
    FOREIGN KEY (`owner`) REFERENCES sub_users(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
create table sub_bangumis_name(
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY (`bangumi_id`) REFERENCES sub_bangumis(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
create table sub_subtitles(
    ...
    PRIMARY KEY (`id`),
    FOREIGN KEY (`uploader`) REFERENCES sub_users(`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1;
