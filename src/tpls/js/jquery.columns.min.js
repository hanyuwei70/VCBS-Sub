...
(function(e) {
    ...
    var t = function(t, n) {
        ...
        this.create = function() {
            ...
            function r(n, r) {
                var i = [];
                n % 2 === 0 ? i.push('<tr data-columns-row-id="' + n + '" class="' + t.evenRowClass + '">') : i.push('<tr data-columns-row-id="' + n + '" class="' + t.oddRowClass + '">');
 ...
 * !!!diy!!!
 * 插件支持Ajax数据
 * schema项目格式与传入json数据相对应，按列按顺序书写
 */
